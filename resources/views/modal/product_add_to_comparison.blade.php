<div class="overlay" id="product_model">
    <div class="popup popup-add">
        ...
        <p class="popup__title">
            Товар добавлен в сравнение товаров!
        </p>
        ...
        <div class="popup-add__btns spacer">
            <a class="popup-add__return model_close">Продолжить</a>
            <a href="{{ url('/comparison') }}" class="yellow-btn popup-add__link">Перейти в сравнение товаров</a>
        </div><!--popup-add__btns-->
