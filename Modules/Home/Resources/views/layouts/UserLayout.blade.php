...
<div class="d-flex flex-column flex-root">
                    ...
                    <div class=" container-fluid ">
                        ...
                        <div class="d-none d-lg-flex align-items-center mr-3">
                            ...
                            <ul class="header-tabs nav align-self-end font-size-lg" role="tablist">
                                ...
                                <li class="nav-item mr-3">
                                    <a href="#" class="nav-link py-4 px-6" data-toggle="tab"
                                       data-target="#Sb_header_reports" role="tab">
                                        Reports
                                    </a>
                                </li>
                                <!--end::Item-->
                        ...
                        <div class="topbar mr-2">
                            ...
                            <div class="theme-switch-wrapper">
                                <span
                                    class="opacity-50 font-weight-bold font-size-sm d-none d-md-inline mt-4">theme</span>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active show p-8" id="topbar_notifications_notifications"
                                        ...
                                        <div class="d-flex flex-center pt-7"><a href="#"
                                                                                class="btn font-weight-bold text-center">See
                                                All</a></div>
                                        <!--end::Action-->
                                    </div>
                                    <!--end::Tabpane-->
                        ...
                        <div class="dropdown">
                            ...
                            <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                                <div class="btn btn-icon btn-dropdown w-lg-auto d-flex align-items-center btn-lg px-2"
                                    ...
                                    <div class="d-flex flex-column text-right pr-lg-3">
                                        <span class="font-weight-bold font-size-sm d-none d-md-inline">Team Name</span>
                                        <span class="font-weight-bolder font-size-sm d-none d-md-inline">team</span>
                                    </div>
                                    <span class="symbol symbol-35">
                                                    <span class="symbol-label font-size-h5 font-weight-bold ">TN</span>
                                                </span>
                                </div>
                            </div>
                            <!--end::User-->
                            ...
                            <div
                                ...
                                <!--begin:Header-->
                                <div
                                    class="d-flex flex-column flex-center py-3 bgi-size-cover bgi-no-repeat rounded-top">
                                    <h4 class="font-weight-bold">
                                        SocioBoard team
                                    </h4>
                                    <span class="btn btn-sm font-weight-bold font-size-sm mt-2">23 tasks pending</span>
                                </div>
                                <!--end:Header-->
                                ...
                                <div class="row row-paddingless">
                                    ...
                                    <div class="col-12">
                                        <a href="#" class="d-block py-3 px-5 text-center bg-hover-light border-bottom">
                                            <span
                                                class="d-block font-weight-bold font-size-h6 mt-2 mb-1">Team one</span>
                                            <span class="d-block font-size-lg">3 members</span>
                                        </a>
                                    </div>
                                    <!--end:Item-->
                                    ...
                                    <div class="col-12">
                                        <a href="#" class="d-block py-3 px-5 text-center bg-hover-light border-bottom">
                                            <span
                                                class="d-block font-weight-bold font-size-h6 mt-2 mb-1">Team two</span>
                                            <span class="d-block font-size-lg">5 members</span>
                                        </a>
                                    </div>
                                    <!--end:Item-->
                                    ...
                                    <div class="col-6">
                                        <a href="/view-teams"
                                           class="d-block py-10 px-5 text-center bg-hover-light border-right">
                                            ...
                                            <span
                                                class="d-block font-weight-bold font-size-h6 mt-2 mb-1">View Teams</span>
                                            <span class="d-block font-size-lg">5 teams</span>
                                        </a>
                                    </div>
                                    <!--end:Item-->
                                    ...
                                    <div class="col-6">
                                        <a href="/create-team"
                                           class="d-block py-10 px-5 text-center bg-hover-light">
                                            ...
                                            <span class="d-block font-size-lg">add new teams</span>
                                        </a>
                                    </div>
                                    <!--end:Item-->
                                </div>
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item  menu-item-submenu" data-menu-toggle="hover"
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="discovery/search_d.html"
                                                                       class="menu-link "><i
                                                                            class="menu-bullet menu-bullet-dot"><span></span></i>
                                                                        <span class="menu-text">Discovery</span></a>
                                                                </li>
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="discovery/search_s.html"
                                                                       class="menu-link "><i
                                                                            class="menu-bullet menu-bullet-dot"><span></span></i>
                                                    ...
                                                    <li class="menu-item  menu-item-submenu" data-menu-toggle="hover"
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="discovery/group_fb.html"
                                                                       class="menu-link ">
                                                                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                                        <span
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="discovery/group_in.html"
                                                                       class="menu-link ">
                                                                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                                        <span
                                        ...
                                        <li class="menu-item  menu-item-submenu menu-item-rel" data-menu-toggle="click"
                                            ...
                                            <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                                <ul class="menu-subnav">
                                                    ...
                                                    <li class="menu-item  menu-item-submenu" data-menu-toggle="hover"
                                                        aria-haspopup="true">
                                                        <a href="content_studio/shareathon_queue.html"
                                                           class="menu-link">
            ...
            <div class="offcanvas-content pr-5 mr-n5">
                ...
                <div class="d-flex align-items-center mt-5">
                    <div class="symbol symbol-100 mr-5">
                        <div class="symbol-label" style="background-image:url(<?php echo SquareProfilePic(); ?>)"></div>
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="navi mt-2">
                            ...
                            <a href="/logout" class="btn btn-sm font-weight-bolder py-2 px-5">Sign Out</a>
                        </div>
                    </div>
                </div>
                <!--end::Header-->
    ...
    {
        if (isset(session()->get('user')['userDetails']['profile_picture'])) {
